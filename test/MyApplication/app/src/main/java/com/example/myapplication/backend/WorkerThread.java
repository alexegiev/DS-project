        ...
        try {
            ...
            if(request.getAction().equals("Add Room")){
                ...
                if (rooms.isEmpty()){
                    ...
                    else if (request.getFilterType().equals("Area")){
                        for (Room room : rooms) {
                    ...
                    else if (request.getFilterType().equals("Dates")){
                        for (Room room : rooms) {
                    ...
                    else if (request.getFilterType().equals("Capacity/People count")){
                        for (Room room : rooms) {
                    ...
                    else if (request.getFilterType().equals("Price")){
                        for (Room room : rooms) {
